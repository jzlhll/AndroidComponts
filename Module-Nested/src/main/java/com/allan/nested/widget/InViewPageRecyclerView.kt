...
import com.tyiot.module.android.utils.dp
 ...
 */
class InViewPageRecyclerView : RecyclerView {
    ...
    override fun dispatchTouchEvent(ev: MotionEvent?): Boolean {
        ...
        when (ev.action) {
            ...
            MotionEvent.ACTION_MOVE -> {
                 ...
                 */
                if (disX > getTriggerViewPagerHorzDistance() && disY < getTriggerViewPagerHorzDistance() * 3) {
