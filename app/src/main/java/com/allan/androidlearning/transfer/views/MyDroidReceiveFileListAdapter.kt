...
class MyDroidReceiveFileListAdapter(val click:(File)->Unit) : BindRcvAdapter<MergedFileInfo, MyDroidReceiveViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyDroidReceiveViewHolder {
        return MyDroidReceiveViewHolder(create(parent), click = click)
    }
}