...
open class ScrollingConstraintLayout : ConstraintLayout, NestedScrollingParent3{
    ...
    /**
     * 子view处理完之后回调
     * [consumed]当前view消耗的值，剩下的再回调给父view
     */
    override fun onNestedScroll(
...
open class SwipeNestedLayout : ScrollingConstraintLayout {
    constructor(context: Context) : super(context)
    constructor(context: Context, attrs: AttributeSet?) : super(context, attrs)
    constructor(context: Context, attrs: AttributeSet?, defStyleAttr: Int) : super(
        context,
     ...
     * 动画结束后回调
     */
    var endAction: Function1<SwipeNestedLayout, Unit>? = null
     ...
     * 插值器
     */
    var resetInterpolator: TimeInterpolator? = null
    ...
    fun animReset(
        ...
        if (realOffsetX != endXValue || realOffsetY != endYValue) {
            ...
            resetInterpolator?.let {
                stopAnim.interpolator = it
            }
            stopAnim.start()
        }
    }
...
open class NestedLayout : SwipeNestedLayout {
    constructor(context: Context) : super(context)
    constructor(context: Context, attrs: AttributeSet?) : super(context, attrs)
    constructor(context: Context, attrs: AttributeSet?, defStyleAttr: Int) : super(
        context,
