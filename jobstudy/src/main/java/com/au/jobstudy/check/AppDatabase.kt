...
import com.au.jobstudy.check.dao.DingDao
import com.au.jobstudy.check.dao.WorkDao
import com.au.module_android.Globals

@Database(entities = [WorkEntity::class, CompletedEntity::class, DingEntity::class], version = 1)
abstract class AppDatabase : RoomDatabase() {
    ...
    abstract fun getDingDao(): DingDao
}