package com.au.module_androidex.toast
...
import com.au.module_androidex.sticktoast.AbstractToastStick.Companion.globalToastHeight
...
import com.au.module_androidex.databinding.LayoutToast1Binding
import com.au.module_androidex.databinding.LayoutToast2Binding
...
class ToastBuilder {
    ...
    fun setOnDialogFragment(dialog: IBaseDialog) : ToastBuilder {
        when (dialog) {
            is AbsDialog -> {
    ...
    fun setOnDialogFragmentByContent(contentFragment: Fragment) : ToastBuilder {
